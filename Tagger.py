...
async def start(event):
  await event.reply("**Merhaba👋\nBen @XEtiketTag_Bot Grubunuzdakı Üyeleri Çok Özelliklerle Etiketleye Bilirim\nKomutlar için =======> /help yazın**",
                    buttons=(
...
async def help(event):
  helptext = "**Çok özellikleri Etiket Botu Bulmaya Çalışan Grub Sahibleri @XEtiketTag_Bot Size Göre:\n\n📌 5-li etiket\n📌 Emoji etiket\n📌 Tekli Etiket\n📌 Yalnız Yöneticileri etiketleme\n📌\n\n Böyle Çok özellikli @XEtiketTag_Bot 'u grubunuza yönetici olarak ekleyip rahatlıkla üyelir , etiket ata bilirsiz **"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Botu Gruba Ekle➕', 'https://t.me/XEtiketTag_bot?startgroup=a')],
                    ),
                    link_preview=False
                   )
